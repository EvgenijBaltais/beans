...
<main class = "wrapper">
	...
	<section class = "section section-welcome" id = "welcome">
		...
		<section class = "section plus-minus">
			...
			<ul class="advantages-block">
				<li class = "advantage-item">
					Наш магазин работает для вас. Мы с удовольствием ответим на любой ваш вопрос и учтем все ваши пожелания. 
				...
				<li class = "advantage-item">
					...
					В результате - потраченные деньги и разочарование в покупке. Это все не про нас.
					 Мы предлагаем товар только от надежных поставщиков и уверены в качестве.</p>
				</li>
				<li class = "advantage-item">
				...
				<li class = "advantage-item">
					...
					Мы будем искать и тестировать интересные новинки и радовать вас
					 новыми позициями в <a href = "/catalog" class = "simply-link">нашем каталоге</a>.
				</li>
			</ul>
		</section>
		...
		<section class = "section section-any-wishes">
			...
			<p class = "simply-text">Форма для обратной связи и предложений.</p>
			<div class = "reviews-form-block">
				<form action="/" name = "reviews-form" class = "reviews-form">
					<div class = "reviews-form-w">
						...
						<button type = "button" class = "reviews-form-send">Отправить!</button>
					</div>
				</form>
