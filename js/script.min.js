                ...
                setTimeout(() => {
                                            ...
                                            <div class = "item-plus-minus">
                                                ...
                                                <div class = "item-amount-val-block">
                                                    <label for = "num-<?=$item['id'];?>">
                                                        <input type="text" name = "item-amount-value" class = "item-amount-value" readonly = "readonly" value = "${item.amount}" id = "num-${item.id}" aria-label="Количество товаров для заказа">
                                                    </label>
                                                </div>
                    ...
                    document.querySelector('.cart-final').insertAdjacentHTML('beforeend', `
                            ...
                            <div class = "cart-common">
                                ...
                                <span class = "cart-common-bold" id = "final-price">${countFinalSumm(products).toLocaleString()} ₽</span>
                            </div>
